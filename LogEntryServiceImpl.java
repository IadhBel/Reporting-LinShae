...
public class LogEntryServiceImpl implements LogEntryService {
	...
	private final ExceptionStatisticMongoRepository exceptionStatisticMongoRepository;
	...
	public LogEntryServiceImpl(final LogEntryRepository logEntryRepository,
			...
			final ExceptionStatisticMongoRepository exceptionStatisticMongoRepository,
	...
	public BasicStatistic generateBasicStatistic(AuditLogEntry entity) {
		...
		exceptionStatisticMongoRepository.insert(new ExceptionsStatistic(1L,"LinShareRootDomain",new Date(),ExceptionType.BusinessException,BasicStatisticType.ONESHOT));
		AbstractDomain parentDomain = domainBusinessService.findById(entity.getAuthUser().getDomain().getUuid())
				.getParentDomain();
		if (parentDomain != null) {
			parentDomainUuid = parentDomain.getUuid();
		}

		return new BasicStatistic(1L, parentDomainUuid, entity, BasicStatisticType.ONESHOT);
	}
